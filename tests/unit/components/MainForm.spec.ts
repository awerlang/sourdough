  ...
  expect(wrapper.html()).toMatchInlineSnapshot(`
    <div class="prose">
      ...
      <form class="max-w-sm">
        ...
        <div><label> Recipe <select class="block w-full h-8 bg-white focus:outline-none focus:shadow-outline focus:border-blue-300">
      ...
      <div class="relative sm:w-11/12 rounded bg-white shadow mx-auto mt-8 p-3">
        <div class="absolute right-0 mt-4 sm:mt-6 rounded-l-full bg-blue-500 text-white py-2 px-8"> Your recipe </div>
        <div class="border border-dashed divide-y border-gray-400 rounded p-8 pt-16">
          <div class="grid gap-2 text-gray-700 py-1" style="grid-template-columns: 2em 2em auto;"><span class="w-4 h-4 border rounded-sm border-gray-400 self-center"></span><span class="text-right">529</span><span>Flour</span></div>
          <div class="grid gap-2 text-gray-700 py-1" style="grid-template-columns: 2em 2em auto;"><span class="w-4 h-4 border rounded-sm border-gray-400 self-center"></span><span class="text-right">381</span><span>Water</span></div>
          <div class="grid gap-2 text-gray-700 py-1" style="grid-template-columns: 2em 2em auto;"><span class="w-4 h-4 border rounded-sm border-gray-400 self-center"></span><span class="text-right">79</span><span>Starter</span></div>
          <div class="grid gap-2 text-gray-700 py-1" style="grid-template-columns: 2em 2em auto;"><span class="w-4 h-4 border rounded-sm border-gray-400 self-center"></span><span class="text-right">11</span><span>Salt</span></div>
        </div>
      </div>
    </div>
  `);
